...
<head>
  <meta charset="utf-8">
  <title>Authorized Workshops</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700;900&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>
  <link href="aaw/css/bootstrap.min.css" rel="stylesheet">
  <link href="aaw/css/style.css" rel="stylesheet">
  <style>
    body {
    ...
    .table-section {
      ...
      padding: 30px;
      border-radius: 10px;
      box-shadow: 0 0 12px rgba(31, 7, 247, 1);
      color: #ffffff;
    }

    .table tbody tr:hover {
  background-color: rgba(194, 194, 194, 0.59); /* subtle highlight */
...
<!-- Page Heading -->
<div class="container">
  <h1 class="main-heading"><span class="admin">Admin</span> <span class="dashboard">Authorized Workshops</span></h1>
</div>

<!-- Authorized Workshops Table -->
<div class="container py-5">
  <h2 class="section-title">List of Approved Workshops</h2>
...
<!-- Scripts -->
<script src="aaw/js/bootstrap.bundle.min.js"></script>
<script src="aaw/js/main.js"></script>
</body>
</html>
